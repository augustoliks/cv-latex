...
\tagline{OBJETIVO: DESENVOLVEDOR INTEGRADOR}
...
\begin{itemize}
    ...
    \item Documentação de código fonte e projetos com Markdown e Sphinx, com acesso via GitLab Pages;
    \item Estudos técnicos com base nas regras de negócio da empresa;
    % (\href{https://pt.wikipedia.org/wiki/Prova_de_conceito}{PoC})
    \item Configuração de Proxy Reverso e ambiente Web seguro, através do NGINX com SSL/TLS.
\end{itemize}
...
\begin{itemize}
    ...
    % \item Integração de sistemas através de API com FastAPI e Flask;
    \item Preparação de ambientes de produção com Docker Compose, e com a criação e otimização de imagens Docker;
...
{\MakeLowercase{python, flask, vue.js, zabbix, grafana, nginx, ansible, LDAP, gitlab}}{Abril 2018 -- Junho 2019}{}
\begin{itemize}
    \item Desenvolvido para a empresa Fotosensores Tecnologia Eletrônica.
\end{itemize}
\divider

\cvevent{Estudos Colaborativos: git-mini-book}
{\MakeLowercase{mkdocs, markdown, git, github, github-actions}}{Dezembro 2020 -- Presente 2021}{}
\begin{itemize}
    \item Repositório de estudos colaborativos sobre a ferramenta Git;
    \item \github{\href{https://github.com/augustoliks/git-mini-book}{https://github.com/augustoliks/git-mini-book}}
\end{itemize}
\divider

\cvevent{Biblioteca Python: gelfguru}
{\MakeLowercase{python, poetry, github, codacy, pypi}}{Maio 2020 -- Junho 2020}{}
\begin{itemize}
