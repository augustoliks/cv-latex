...
\begin{itemize}
    \item Apresenta dados de monitoramento de forma objetiva, constatando a inoperabilidade de equipamentos fiscalizadores de trânsitos. O sistema contribui diretamente com a diminuição de glosas contratuais.
\end{itemize}
\divider
