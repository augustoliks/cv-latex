...
\begin{itemize}
    \item Desenvolvimento de bibliotecas, scripts e sistemas de integração com Python;
    ...
    \item Ingestão de logs com Rsyslog, Fluent Bit, Redis e Journald;
    \item Criação de plugins Rsyslog com Python e Go;
    \item Coleta e padronização de métricas com Prometheus;
    \item Exibição de métricas com Grafana, Zabbix e Graylog;
    ...
    \item Padronização de rotinas de CI/CD com Gitlab integrado ao Nexus Repository para a constução de:
        \begin{itemize}
...
\begin{itemize}
    \item Configuração e automação de testes de performance de sensores metrológicos de trânsitos com Python;
    \item Criação de scripts de automação de tarefas de infra com Python e Shell Script;
    \item Criação de sistema de transmissão de dados de forma segura com Python e NGINX;
\end{itemize}
...
\begin{itemize}
    \item Apresenta dados de monitoramento de forma objetiva, constatando a inoperabilidade de equipamentos fiscalizadores de trânsitos. O sistema contribui diretamente com a diminuição glosas contratuais.
\end{itemize}
\divider
...
\begin{itemize}
    \item Responsável pelo envio de dados dos equipamentos de fiscalizadores de trânsito. O sistema evita inconstência de dados, contribuindo com o aproveitamento de operação dos equipamentos.
\end{itemize}
