...
\begin{itemize}
    ...
    \item Exibição de métricas com Grafana e Graylog;
...
\begin{itemize}
    \item Apresenta dados de monitoramento de forma intuitiva e objetiva. Contribui diretamente na constatação de problemas nos equipamentos, agilizando o processo de abertura de Ordem de Serviço de manutenção dos equipamentos.
\end{itemize}
\divider
