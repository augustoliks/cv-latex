...
\begin{itemize}
    \item Apresenta dados de monitoramento de forma intuitiva e objetiva. Focado na facilidade de rastreabilidade, o sistema contribui diretamente na agilidade de constatação de problemas de inoperabilidade dos equipamentos.
\end{itemize}
\divider
...
\begin{itemize}
    \item Responsável pelo envio de dados dos equipamentos de fiscalizadores de trânsito. Focado em confiabilidade e integridade, o sistema evita inconstência de dados, contribuindo com o SLA dos contratos.
\end{itemize}
